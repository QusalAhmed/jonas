...
// Local
import ScrollLinked from "./ProgressBar";
...
export default function Navbar() {
    ...
    const onSearch = (e: React.FormEvent) => {
        ...
        // Navigate to the product page (placeholder search param)
    ...
    return (
        <>
            <header className="top-0 z-40 w-full border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
                <div className="container mx-auto px-4">
                    <div className="h-16 flex items-center justify-between gap-3">
                        ...
                        {/* Logo */}
                        {/*<Link href="/" className="flex items-center gap-2 shrink-0 mt-4">*/}
                        {/*    <Image*/}
                        {/*        src={logo.src}*/}
                        {/*        alt="Logo"*/}
                        {/*        width={200}*/}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link href="/posts" className="hidden md:inline-flex">
                        ...
                        <div className="md:hidden pb-4 animate-in slide-in-from-top-2 fade-in-0">
                            ...
                            <nav className="flex flex-col gap-1">
                                <Link href="/" onClick={() => setOpen(false)}
                                      className="px-2 py-2 rounded hover:bg-gray-100">Home</Link>
                                <Link href="/product" onClick={() => setOpen(false)}
                                      className="px-2 py-2 rounded hover:bg-gray-100">Shop</Link>
                                <Link href="/cart" onClick={() => setOpen(false)}
                                      className="px-2 py-2 rounded hover:bg-gray-100">Cart</Link>
                            </nav>
                        </div>
                    )}
                </div>
